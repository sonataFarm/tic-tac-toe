...
describe "Game" do
  ...
  let(:game) do
    Game.new(players: [player_one, player_two])
  end
  ...
  before(:each) do
    ...
    allow(player_one).to receive(:assign_mark)
    allow(player_two).to receive(:assign_mark)
  end
  ...
  describe "#play_turn" do
    ...
    before(:each) do
      ...
      allow(player_one).to receive(:get_move).and_return(move)
    end
